    ...
    add(lasers, {x1 = x1,
                ...
                update=function(self, pl)
                    ...
                    for zombie in all(zombies) do
                        fzx = flr(zombie.x)
                        fzy = flr(zombie.y)
                        if(self.x1 <= fzx and fzx <= self.x2) and 
                            (self.y1 <= fzy and fzy <= self.y2) then
                            zombie:lose_health(pl, 2)
                            shakestart=true
                        end
                    end
...

...

