    ...
    for j=0, map_height do
        ...
        for i=0, map_width do
            if(p.x - 9 <= i and i <= p.x + 9) and (p.y - 9 <= j and j <= p.y + 9) then
                if ((m[j][i] == 0 or m[j][i] > 10) and not surround_light(i, j, m, p) and not (j == flr(p.y) and i == flr(p.x))) or
                    (not surround_light(i,j,m,p) and surround_only_decor(i,j,m)) then
                    spr(11, i*8, j*8)
                end
                if m[j][i] == 11 then 
                    spr(10, i*8, j*8)
...
function surround_light(x, y, m, pl)
    ...
    for i = 0, 3 do
        ...
        if(tileval > 0 and tileval <= 10) or (tileval == 0 and (y + key_direction[i].y == flr(pl.y)) and (x + key_direction[i].x == flr(pl.x))) then
            return true
        end
    end 
    return false
...
function surround_only_decor(x, y, m)
    if(x == 0 or y == 0 or x == map_width or y == map_height) then
        return true
    end
    for i = 0, 3 do
        if(not fget(mget(x + key_direction[i].x, y + key_direction[i].y), 2)) then
            return false
        end
    end 
    return true
...

...
__gff__

...

