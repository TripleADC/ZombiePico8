    ...
    for j=0, map_height do
        ...
        for i=0, map_width do
            if(p.x - 9 <= i and i <= p.x + 9) and (p.y - 9 <= j and j <= p.y + 9) then
                ...
                if ((m[j][i] == 0 or m[j][i] > 12) and not surround_player(i, j, m, pl) and not (j == flr(p.y) and i == flr(p.x))) then
                    spr(11, i*8, j*8)
                end
                if m[j][i] == 12 then 
                    spr(10, i*8, j*8)
...
function solid_player_only(x,y)
	return fget(mget(x,y),3)
end

function solid_area_player_only(x,y,w,h)
 return 
  solid_player_only(x-w,y-h) or
  solid_player_only(x+w,y-h) or
  solid_player_only(x-w,y+h) or
  solid_player_only(x+w,y+h)
end

__gfx__

...
__gff__

...

...

