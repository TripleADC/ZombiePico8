    ...
    pl={
        ...
        control=function(self, c)
            ...
            if(self.laser_timer == 0 and self.laser_charging) then
                ...
                if self.facing == 1 then -- right
                    make_laser(self.x + 1, self.y - 1, self.x + 16, self.y + 1)
                elseif self.facing == 2 then -- down
                    make_laser(self.x - 1, self.y + 1, self.x + 1, self.y + 16)
                elseif self.facing == 3 then -- left
                    make_laser(self.x - 16, self.y - 1, self.x - 2, self.y + 1)   
                else -- up
                    make_laser(self.x - 1, self.y - 16, self.x + 1, self.y - 2)
                end
            end
...
__gff__

...

